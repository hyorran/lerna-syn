...
import datagridOppositeLawyerStore from './store'

import styles from './styles'

@inject('datagridOppositeLawyerStore')
@observer
class DatagridOppositeLawyerContainer extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    const {
      datagridOppositeLawyerStore: store,
      dialogId,
      onDblClick
    } = this.props
...
DatagridOppositeLawyerContainer.propTypes = {
  ...
  datagridOppositeLawyerStore: MobxPropTypes.objectOrObservableObject
}

DatagridOppositeLawyerContainer.defaultProps = {
  onSelectClickRow: () => {},
  onUnselectClickRow: () => {},
  formCallback: () => {},
  onDblClick: () => {}
...
export default flow(
  withStyles(styles),
  withStores({ datagridOppositeLawyerStore })
)(DatagridOppositeLawyerContainer)
