...
import { getAssignments, putAssignments } from '@syntesis/s-assignments'

class DatagridAssignmentsLogsStore extends DatagridClientSideStore {
  constructor() {
    super({
      endpoint: 'Projects/Assignments/Logs',
      columns: [
        {
          Header: 'Data/Hora',
          accessor: 'dateLog',
  ...
  async updateItem(values, cb = {}) {
    try {
      ...
      await putAssignments({ ...response, ...values })
...
const store = new DatagridAssignmentsLogsStore()
