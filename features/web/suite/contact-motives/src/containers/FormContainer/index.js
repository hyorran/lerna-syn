...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formContactMotivesStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para o motivo de contato"
          ...
          <TextInput
            name="title"
            label="Título"
            helperText="Informe um título para o motivo de contato"
          ...
          <TextArea
            name="description"
            label="Descrição"
            helperText="Informe uma descrição para o motivo de contato"
...
export default flow(
  withStyles(styles),
  withStores({ formContactMotivesStore })
)(FormContainer)
