...
import formContactFormsFilterStore from '../stores/formContactFormsFilterStore'
import datagridContactFormsStore from '../stores/datagridContactFormsStore'
...
@inject('formContactFormsFilterStore')
@inject('datagridContactFormsStore')
@observer
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formContactFormsStore: { registerFallback },
      datagridContactFormsStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ ShipWheelIcon }
                wikiPageId={ wikiPageIds.suite.contactForms }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  datagridContactFormsStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formContactFormsStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formContactFormsFilterStore: MobxPropTypes.objectOrObservableObject
}
