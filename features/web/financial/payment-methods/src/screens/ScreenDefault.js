...
import datagridPaymentMethodStore from '../stores/datagridPaymentMethodStore'
...
@inject('datagridPaymentMethodStore')
@observer
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formPaymentMethodStore: { registerFallback },
      datagridPaymentMethodStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ WalletIcon }
                wikiPageId={ wikiPageIds.financial.paymentMethods }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  datagridPaymentMethodStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
