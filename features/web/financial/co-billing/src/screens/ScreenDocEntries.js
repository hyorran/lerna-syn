...
import DatagridDocEntriesContainer from '../containers/EntriesContainers/DatagridDocEntriesContainer'
...
@observer
class ScreenDocEntries extends Component {
  constructor(props) {
    super(props)
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ SquareCashIcon }
                wikiPageId={ wikiPageIds.financial.coBilling.docEntries }
                summaryButton
              />
            </Card>
            <Card className={ classes.datagridContainer }>
              <DatagridDocEntriesContainer feature={ feature } />
            </Card>
          </Grid>
        </Grid>
      </div>
...
ScreenDocEntries.defaultProps = {
  params: {},
  withoutTabContents: false
}

export default flow(
  withStores({ datagridDocEntriesStore }),
  withStyles(styles)
)(ScreenDocEntries)
