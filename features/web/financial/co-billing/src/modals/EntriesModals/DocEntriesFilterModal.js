...
import FormDocEntriesFilterContainer from '../../containers/EntriesContainers/FormDocEntriesFilterContainer'

@inject('formDocEntriesFilterStore')
@observer
class DocEntriesFilterModal extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <Confirm
        ...
        contentComponent={ FormDocEntriesFilterContainer }
        open={ open }
        dialogId={ dialogId }
...
DocEntriesFilterModal.propTypes = {
...
DocEntriesFilterModal.defaultProps = {
  modalProps: {},
  onSuccess: () => {}
}

export default withStores({ formDocEntriesFilterStore })(DocEntriesFilterModal)
