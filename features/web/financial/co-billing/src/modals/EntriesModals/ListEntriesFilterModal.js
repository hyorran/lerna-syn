...
import FormListEntriesFilterContainer from '../../containers/EntriesContainers/FormListEntriesFilterContainer'

@inject('formListEntriesFilterStore')
@observer
class ListEntriesFilterModal extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <Confirm
        ...
        contentComponent={ FormListEntriesFilterContainer }
        open={ open }
        dialogId={ dialogId }
...
ListEntriesFilterModal.propTypes = {
...
ListEntriesFilterModal.defaultProps = {
  modalProps: {},
  onSuccess: () => {}
}

export default withStores({ formListEntriesFilterStore })(ListEntriesFilterModal)
