...
import FormEntriesFilterContainer from '../../containers/EntriesContainers/FormEntriesFilterContainer'

@inject('formEntriesFilterStore')
@observer
class EntriesFilterModal extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <Confirm
        ...
        contentComponent={ FormEntriesFilterContainer }
        open={ open }
        dialogId={ dialogId }
...
EntriesFilterModal.defaultProps = {
  modalProps: {},
  onSuccess: () => {}
}

export default withStores({ formEntriesFilterStore })(EntriesFilterModal)
