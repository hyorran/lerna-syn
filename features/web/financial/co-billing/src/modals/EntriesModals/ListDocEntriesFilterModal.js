...
import FormListDocEntriesFilterContainer from '../../containers/EntriesContainers/FormListDocEntriesFilterContainer'

@inject('formListDocEntriesFilterStore')
@observer
class ListDocEntriesFilterModal extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <Confirm
        ...
        contentComponent={ FormListDocEntriesFilterContainer }
        open={ open }
        dialogId={ dialogId }
...
ListDocEntriesFilterModal.propTypes = {
...
ListDocEntriesFilterModal.defaultProps = {
  modalProps: {},
  onSuccess: () => {}
}

export default withStores({ formListDocEntriesFilterStore })(ListDocEntriesFilterModal)
