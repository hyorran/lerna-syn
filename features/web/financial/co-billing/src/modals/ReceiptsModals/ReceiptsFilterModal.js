...
import FormReceiptsFilterContainer from '../../containers/ReceiptsContainers/FormReceiptsFilterContainer'
  ...
  render() {
    ...
    return (
      <Confirm
        ...
        contentComponent={ FormReceiptsFilterContainer }
        open={ open }
        dialogId={ dialogId }
...
export default withStores({ formReceiptsFilterStore })(ReceiptsFilterModal)
