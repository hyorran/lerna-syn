...
import FormListReceiptsFilterContainer from '../../containers/ReceiptsContainers/FormListReceiptsFilterContainer'

@inject('formListReceiptsFilterStore')
@observer
class ListReceiptsFilterModal extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <Confirm
        ...
        contentComponent={ FormListReceiptsFilterContainer }
        open={ open }
        dialogId={ dialogId }
...
ListReceiptsFilterModal.propTypes = {
...
ListReceiptsFilterModal.defaultProps = {
  modalProps: {},
  onSuccess: () => {}
}

export default withStores({ formListReceiptsFilterStore })(ListReceiptsFilterModal)
