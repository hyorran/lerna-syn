...
class DatagridListEntriesStore extends DatagridServerSideStore {
  constructor() {
    super({
      initialFetch: false,
      endpoint: 'financial/cobilling/getpagedentriesreceivables',
      params: {
        OrderBy: [
          {
...
const store = new DatagridListEntriesStore()
