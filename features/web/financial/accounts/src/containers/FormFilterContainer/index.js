...
import { getBankAccountsForSelect } from '@syntesis/s-bank-accounts'
        ...
        <Grid container spacing={ 16 }>
          ...
          >
            <CurrencyInput
              ...
              helperText={ 'Saldo inicial da conta bancária na data definida no campo "Data"' }
          ...
          >
            <AutocompleteInput
              name="signal"
              label={ signal.label }
              helperText="Este campo define o sinal do saldo cadastrado"
          ...
          isTeller
            ? (
              <Checkbox
                ...
                checked={ accountAttendance.checked }
