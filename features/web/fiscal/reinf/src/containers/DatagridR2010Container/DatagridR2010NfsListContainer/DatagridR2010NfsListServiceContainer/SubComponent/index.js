      ...
      <Fragment>
        <div className={ classes.container } >
          ...
          <Chip
            ...
            tooltip="Adicional apurado de retenção da Nota Fiscal, caso os serviços tenham sido prestados sob condições especiais que ensejem aposentadoria especial aos trabalhadores após 15, 20, ou 25 anos de contribuição."
          />
          <Chip
            label="Valor dos serviços com atividade de consessão após 15 anos"
            value={ formatMoney(serviceValue15) }
            tooltip="Valor dos Serviços prestados por segurados em condições especiais, cuja atividade permita concessão de aposentadoria especial após 15 anos de contribuição."
          />
          <Chip
            label="Valor dos serviços com atividade de consessão após 20 anos"
            value={ formatMoney(serviceValue20) }
            tooltip="Valor dos Serviços prestados por segurados em condições especiais, cuja atividade permita concessão de aposentadoria especial após 20 anos de contribuição."
          />
          <Chip
            label="Valor dos serviços com atividade de consessão após 25 anos"
            value={ formatMoney(serviceValue25) }
            tooltip="Valor dos Serviços prestados por segurados em condições especiais, cuja atividade permita concessão de aposentadoria especial após 25 anos de contribuição."
          />
        </div>
      </Fragment>
    )
