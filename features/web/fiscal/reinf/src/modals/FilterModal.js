...
import formReinfFilterStore from '../stores/formReinfFilterStore'
import FormFilterContainer from '../containers/FormFilterContainer'

@inject('formReinfFilterStore')
@observer
...
FilterModal.propTypes = {
  ...
  formReinfFilterStore: MobxPropTypes.objectOrObservableObject,
}
...
export default withStores({ formReinfFilterStore })(FilterModal)
