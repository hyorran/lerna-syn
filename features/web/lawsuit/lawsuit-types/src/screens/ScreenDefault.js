...
import formLawsuitTypesFilterStore from '../stores/formLawsuitTypesFilterStore'
...
@inject('formLawsuitTypesFilterStore')
...
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formLawsuitTypesStore: { registerFallback },
      datagridLawsuitTypesStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.lawsuitTypes }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  // eslint-disable-next-line react/require-default-props
  formLawsuitTypesFilterStore: MobxPropTypes.objectOrObservableObject
}
