...
import formBriefcasesFilterStore from '../stores/formBriefcasesFilterStore'
import datagridBriefcasesStore from '../stores/datagridBriefcasesStore'
...
@inject('formBriefcasesFilterStore')
@inject('datagridBriefcasesStore')
@observer
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formBriefcasesStore: { registerFallback },
      datagridBriefcasesStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.briefcases }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  datagridBriefcasesStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formBriefcasesStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formBriefcasesFilterStore: MobxPropTypes.objectOrObservableObject
}
