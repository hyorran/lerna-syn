...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formDecisionsStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para a decisão"
          ...
          <TextInput
            name="name"
            label="Descrição"
            helperText="Informe uma descrição para a decisão"
            value={ name.value }
