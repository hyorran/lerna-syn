...
import formDistribuitionsStore from '../stores/formDistribuitionsStore'
import formDistribuitionsFilterStore from '../stores/formDistribuitionsFilterStore'
import datagridDistribuitionsStore from '../stores/datagridDistribuitionsStore'
...
@inject('formDistribuitionsStore')
@inject('formDistribuitionsFilterStore')
...
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formDistribuitionsStore: { registerFallback },
      datagridDistribuitionsStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.distribuitions }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  // eslint-disable-next-line react/require-default-props
  formDistribuitionsStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formDistribuitionsFilterStore: MobxPropTypes.objectOrObservableObject
}
