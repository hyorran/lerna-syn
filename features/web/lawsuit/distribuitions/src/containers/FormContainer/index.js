...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formDistribuitionsStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para a distribuição"
          ...
          <TextInput
            name="name"
            label="Descrição"
            helperText="Informe uma descrição para a distribuição"
            value={ name.value }
...
export default flow(
  withStyles(styles),
  withStores({ formDistribuitionsStore })
)(FormContainer)
