...
import formLocalsFilterStore from '../stores/formLocalsFilterStore'
import datagridLocalsStore from '../stores/datagridLocalsStore'
...
@inject('formLocalsFilterStore')
@inject('datagridLocalsStore')
@observer
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formLocalsStore: { registerFallback },
      datagridLocalsStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.locals }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  datagridLocalsStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formLocalsStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formLocalsFilterStore: MobxPropTypes.objectOrObservableObject
}
