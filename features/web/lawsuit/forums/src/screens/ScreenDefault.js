...
import formForumsStore from '../stores/formForumsStore'
import formForumsFilterStore from '../stores/formForumsFilterStore'
...
@inject('formForumsStore')
@inject('formForumsFilterStore')
...
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formForumsStore: { registerFallback },
      datagridForumsStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.forums }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  // eslint-disable-next-line react/require-default-props
  formForumsStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formForumsFilterStore: MobxPropTypes.objectOrObservableObject
}
