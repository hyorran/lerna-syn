...
import forumsFilterStore from '../../stores/formForumsFilterStore'

import styles from './styles'

@inject('forumsFilterStore')
@observer
class FormFilterContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.forumsFilterStore.changeFormControl(controlName, control)
  }

  render() {
    const {
      forumsFilterStore: store,
    } = this.props
...
FormFilterContainer.propTypes = {
  ...
  forumsFilterStore: MobxPropTypes.objectOrObservableObject
}
