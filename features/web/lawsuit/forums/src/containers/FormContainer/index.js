...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formForumsStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para o fórum"
          ...
          <TextInput
            name="name"
            label="Descrição"
            helperText="Informe uma descrição para o fórum"
            value={ name.value }
