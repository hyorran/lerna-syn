...
import FilterDeletedModal from '../../modals/FilterDeletedModal'

import styles from './styles'

@inject('datagridExpedientNotesDeletedStore')
@observer
class DatagridDeletedContainer extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    const {
      feature,
      datagridExpedientNotesDeletedStore: store,
      changeFormControl,
      clearFilters
    } = this.props
    ...
    return (
      <DatagridServerSide
        ...
        advancedFilterModalConfig={ {
          modalComponent: FilterDeletedModal,
          modalProps: {
...
DatagridDeletedContainer.propTypes = {
...
DatagridDeletedContainer.defaultProps = {
  onSelectClickRow: () => {},
  onUnselectClickRow: () => {},
  formCallback: () => {},
  clearFilters: () => {}
...
export default flow(
  withStyles(styles),
  withStores({ datagridExpedientNotesDeletedStore })
