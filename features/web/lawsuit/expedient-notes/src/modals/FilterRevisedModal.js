...
import FormFilterRevisedContainer from '../containers/FormFilterRevisedContainer'

@inject('formExpedientNotesFilterRevisedStore')
@observer
class FormRevisedModal extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <Confirm
        ...
        contentComponent={ FormFilterRevisedContainer }
        open={ open }
        dialogId={ dialogId }
...
FormRevisedModal.defaultProps = {
  modalProps: {},
  onSuccess: () => {}
}

export default withStores({ formExpedientNotesFilterRevisedStore })(FormRevisedModal)
