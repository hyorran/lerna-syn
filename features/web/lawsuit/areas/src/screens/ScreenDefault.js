...
import formAreasStore from '../stores/formAreasStore'
import formAreasFilterStore from '../stores/formAreasFilterStore'
...
@inject('formAreasStore')
@inject('formAreasFilterStore')
...
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formAreasStore: { registerFallback },
      datagridAreasStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.areas }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  // eslint-disable-next-line react/require-default-props
  formAreasStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formAreasFilterStore: MobxPropTypes.objectOrObservableObject
}
