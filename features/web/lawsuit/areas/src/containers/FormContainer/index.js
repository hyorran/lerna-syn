...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formAreasStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para a área de atuação"
          ...
          <TextInput
            name="name"
            label="Descrição"
            helperText="Informe uma descrição para a área de atuação"
            value={ name.value }
