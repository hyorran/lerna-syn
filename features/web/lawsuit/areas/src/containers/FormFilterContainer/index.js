...
import areasFilterStore from '../../stores/formAreasFilterStore'

import styles from './styles'

@inject('areasFilterStore')
@observer
class FormFilterContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.areasFilterStore.changeFormControl(controlName, control)
  }

  render() {
    const {
      areasFilterStore: store,
    } = this.props
...
FormFilterContainer.propTypes = {
  ...
  areasFilterStore: MobxPropTypes.objectOrObservableObject
}
