...
import { getAreas, putAreas } from '@syntesis/s-areas'

class DatagridAreasLogsStore extends DatagridClientSideStore {
  constructor() {
    super({
      endpoint: 'Lawsuit/Areas/Logs',
      // params: {
      //   PageSize: 15
      // },
      columns: [
  ...
  async updateItem(values, cb = {}) {
    try {
      ...
      await putAreas({ ...response, ...values })
...
const store = new DatagridAreasLogsStore()
