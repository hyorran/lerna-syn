...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formActobjectsStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para o objeto da ação"
          ...
          <TextArea
            name="name"
            label="Descrição"
            helperText="Informe uma descrição para o objeto da ação"
            value={ name.value }
...
export default flow(
  withStyles(styles),
  withStores({ formActobjectsStore })
)(FormContainer)
