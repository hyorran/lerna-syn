...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formCourtsStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para o tribunal"
          ...
          <TextInput
            name="name"
            label="Descrição"
            helperText="Informe uma descrição para o tribunal"
            value={ name.value }
