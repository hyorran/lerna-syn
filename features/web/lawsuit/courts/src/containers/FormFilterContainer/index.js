...
import courtsFilterStore from '../../stores/formCourtsFilterStore'

import styles from './styles'

@inject('courtsFilterStore')
@observer
class FormFilterContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.courtsFilterStore.changeFormControl(controlName, control)
  }

  render() {
    const {
      courtsFilterStore: store,
    } = this.props
...
FormFilterContainer.propTypes = {
  ...
  courtsFilterStore: MobxPropTypes.objectOrObservableObject
}
