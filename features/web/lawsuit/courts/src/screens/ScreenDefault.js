...
import formCourtsFilterStore from '../stores/formCourtsFilterStore'
...
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formCourtsStore: { registerFallback },
      datagridCourtsStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.courts }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  // eslint-disable-next-line react/require-default-props
  formCourtsFilterStore: MobxPropTypes.objectOrObservableObject
}
