...
class FormContainer extends Component {
  ...
  onFormChange(controlName, control) {
    this.props.formActtypesStore.changeFormControl(controlName, control)
  }
      ...
      <div>
        ...
        >
          ...
          <TextInput
            ...
            name="code"
            label="Código"
            helperText="Informe um código para o tipo de ação"
          ...
          <TextInput
            name="name"
            label="Descrição"
            helperText="Informe uma descrição para o tipo de ação"
            value={ name.value }
