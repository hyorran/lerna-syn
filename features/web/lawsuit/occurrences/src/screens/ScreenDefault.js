...
import formOccurrencesFilterStore from '../stores/formOccurrencesFilterStore'
import datagridOccurrencesStore from '../stores/datagridOccurrencesStore'
...
@inject('formOccurrencesFilterStore')
@inject('datagridOccurrencesStore')
@observer
class ScreenDefault extends Component {
  ...
  componentDidMount() {
    const {
      formOccurrencesStore: { registerFallback },
      datagridOccurrencesStore: { getDatagridData }
    } = this.props
          ...
          >
            <Card>
              <PageTitle
                ...
                Icon={ GavelIcon }
                wikiPageId={ wikiPageIds.lawsuit.occurrences }
                summaryButton
              />
            </Card>
...
ScreenDefault.propTypes = {
  ...
  datagridOccurrencesStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formOccurrencesStore: MobxPropTypes.objectOrObservableObject,
  // eslint-disable-next-line react/require-default-props
  formOccurrencesFilterStore: MobxPropTypes.objectOrObservableObject
}
